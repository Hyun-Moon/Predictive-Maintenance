...
정직성을 위해 남깁니다. **이 문서의 결론 하나가 다음 단계에서 수정됐습니다.**

이 단계에서는 이동평균을 걸어도 효과가 거의 없어(0.624 → 0.640)
"노이즈는 주범이 아니다"라고 정리했습니다.
그런데 2단계에서 **개체차를 먼저 보정한 뒤** 같은 이동평균을 걸었더니
0.890 → **0.943** 으로 뚜렷하게 개선됐습니다.

→ 올바른 결론은 **"이동평균은 효과 없음"이 아니라
  "개체차를 먼저 걷어낸 뒤에 적용해야 효과가 있음"** 입니다.
  큰 오차가 남아 있는 상태에서 작은 오차를 다듬어봐야 티가 나지 않습니다.

자세한 내용: [03_health_index.md](03_health_index.md) 및 실험 기록 2-3 항목.
